      ...
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex item-center space-x-3'>
                  ...
                  <p className='ml-3 text-sm font*medium tex-indigo-600 hover:text-indigo-500'>3870 Reviews</p>
                </div>
              </div>
              ...
              <Grid item xs={5}>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container alignItems='center' gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress variant='determinate' value={15} className='bg-yellow-300' sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} />
                    </Grid>
                  </Grid>
                  <Grid container alignItems='center' gap={2}>
                    <Grid item xs={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress variant='determinate' value={8} color='warning' sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} />
                    </Grid>
                  </Grid>
                  <Grid container alignItems='center' gap={2}>
                    <Grid item xs={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress variant='determinate' value={4} color='error' sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }} />
                    </Grid>
                  </Grid>
                </Box>
              </Grid>
        ...
        <section className='pt-10'>
          ...
          <div className='flex flex-wrap space-y-5'>
            {men_jacket.map((item)=><HomeSectionCard product={item}/>)}
          </div>
        </section>
      </div>
    </div>
